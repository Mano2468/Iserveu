(function() {
	'use strict';
	var NonKycFormfactory = function($http,API) {
		var Nonkycfactory = {};
...
//		};
	...
	NonKycFormfactory.$inject = [ "$http" ,"API"];
	angular.module("app").factory('NonKycFormfactory', NonKycFormfactory);
}());

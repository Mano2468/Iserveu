(function() {
	'use strict';
	var AgentTransactionController = function($http, $scope, $location,
		...
		$scope.MoneyTransactionSubmit = function() {
			...
			$http({
				method : 'POST',
				url : API +'cashagenttransactionhistory.json',
	...
	AgentTransactionController.$inject = [ '$http', '$scope', '$location',
			'$filter', 'AlertDialogFactory', 'AddBenefactory','API'];
	angular.module('app').controller('AgentTransactionController',

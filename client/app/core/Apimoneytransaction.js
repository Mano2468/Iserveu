(function() {
    'use strict';
    var ApiMoneyTransactionController = function($http, $scope,$filter,$location,AlertDialogFactory
      ,ApiAddBenefactory,API) {
        ...
        $scope.Agenttransaction = function(){
            var CardNo = ApiAddBenefactory.getBeneData();
                if(!(CardNo == null)){
                  $location.path("page/Apiagenttransaction");
              }else{
        ...
        $scope.MoneyTransactionSubmit = function() {
            ...
            $http({
                method: 'POST',
                url: API+ 'dcashtransactionhistory.json',
    ...
    ApiMoneyTransactionController.$inject = ['$http', '$scope','$filter','$location',
        'AlertDialogFactory','ApiAddBenefactory','API'
    ];
    angular.module('app').controller('ApiMoneyTransactionController',
        ApiMoneyTransactionController);
}());

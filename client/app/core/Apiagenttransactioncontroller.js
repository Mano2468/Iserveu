(function() {
    'use strict';
    var ApiAgentTransactionController = function($http, $scope,$location,$filter,AlertDialogFactory,
     ...
     $scope.datafetchflag = false;
        ...
        $scope.MoneyTransactionSubmit = function() {
            ...
            $http({
                method: 'POST',
                url: API+'dcashagenttransactionhistory.json',
    ...
    ApiAgentTransactionController.$inject = ['$http', '$scope','$location','$filter',
        'AlertDialogFactory','ApiAddBenefactory','API'
    ];
    angular.module('app').controller('ApiAgentTransactionController',
    		ApiAgentTransactionController);
}());

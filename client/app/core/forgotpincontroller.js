(function() {
    ...
    var ForgotPincontroller = function($scope,$http,$location,AlertDialogFactory,API) {
        $scope.forgotmodel={};
  ...
  $scope.Pin = function(){
    ...
    ForgotPincontroller.$inject = [ '$scope','$http','$location','AlertDialogFactory','API'];
    angular.module('app').controller('ForgotPincontroller', ForgotPincontroller);
}());
